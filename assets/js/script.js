...
const bancoDeIlhas = {
    ...
    "Calm Belt": [
        ...
        { nome: "Ecdysis", afiliacaoTexto: "Pirata", afiliacaoClasse: "pirata", descricao: `<p style="margin-bottom: 15px;">Antiga base da Marinha. Após as Piratas Supernova da tripulação Lótus de Ferro, <u>Astarion D. Emiri</u> e <u>Kozuki Ryōshū</u>, matarem os dois Vice-Almirantes responsáveis por cuidar do local, <u>MahaD Mnaj</u> e <u>Serm D'yos</u>, e tirarem também a vida de 62.000 marinheiros, o local foi abandonado pela Marinha. Fronteira da Grand Line com o South Blue no Calm Belt.</p>` },
...
const recursosDasIlhas = {
    ...
    "Ecdysis": ["Materiais de Criadores 1"],
...
window.donosDeAkuma = {
    ...
    "Poke Poke no Mi": "Katanasuke Sushimoto",
    ...
    "Ryū Ryū no Mi, Modelo: Pteranodonte": "Issei Sagawa",
    "Ryū Ryū no Mi, Modelo: Tiranossauro Rex [Original do RPG]": "Atō",
    "Shiku Shiku no Mi": "???",
